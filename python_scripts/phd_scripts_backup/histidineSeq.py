...
parser.add_argument(
    ...
    type=int,
    default=3,
    help="Number of repitions in Hydrophilic block " + "(default: %(default)s)",
    required=False,
)
parser.add_argument(
    "-hisl",
...
# additional flags
parser.add_argument(
    "-ncap", action="store_true", help="N Terminal cap applied? (default: %(default)s)"
)
parser.add_argument(
    "-ccap", action="store_true", help="C Terminal cap applied? (default: %(default)s)"
)
parser.add_argument(
    "-prot",
    action="store_true",
...
if args.ncap:
    fname = fname + "_Ncapped"
if args.ccap:
    fname = fname + "_Ccapped"
if his_prot:
    fname = fname + "_Prot"
