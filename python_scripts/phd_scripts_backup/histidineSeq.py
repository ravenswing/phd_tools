...
# required arguments
parser.add_argument("-x", type=str, default='GLY',
                    help='Additional Inserted residue (default: %(default)s)')
# optional arguments
parser.add_argument("-r", type=int, default=3,
                    help='Number of repitions in Hydrophilic block '+
...
parser.add_argument("-hisl", type=int, default=3,
                    ...
                    required=False)
# additional flags
parser.add_argument("-ncap", action="store_true",
                    help='N Terminal cap applied? (default: %(default)s)')
parser.add_argument("-ccap", action="store_true",
                    help='C Terminal cap applied? (default: %(default)s)')
parser.add_argument("-prot", action="store_true",
                    help='PROTonation of histidines (default: %(default)s)')
